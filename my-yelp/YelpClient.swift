...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func searchWithTerm(term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, distance: String?, completion: ([Business]!, NSError!) -> Void) -> AFHTTPRequestOperation {
        var parameters: [String : AnyObject] = ["term": term, "ll": "37.785771,-122.406165"]
